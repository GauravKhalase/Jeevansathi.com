...
const RegistrationHeader = ({header}) => {
  return (
    ...
    <div className="w-[990px] flex flex-col justify-center item-center mx-auto">
      <RegistrationNavbar />
      <div className=" z-50 flex flex-row justify-center mt-[135px]  text-[16px] font-medium ">{
        header ? (<p className='text-[20px] text-gray-100 font-thin tracking-wide'>{header}</p>):(<div className="fixed w-[800px] flex flex-row justify-center border-b-[1px] border-gray-400 text-gray-400 pb-[10px]">
